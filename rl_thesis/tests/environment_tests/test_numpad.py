...
from rl_thesis.environments.numpad_discrete.numpad import Numpad2DDiscrete
from rl_thesis.environments.numpad_discrete.config import Config as DiscreteConfig

from rl_thesis.environments.numpad_continuous.numpad import Numpad2DContinuous
from rl_thesis.environments.numpad_continuous.config import Config as ContinuousConfig
