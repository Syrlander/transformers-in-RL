...
def add_arguments(parser):
    ...
    parser.add_argument('--encoder', type=str, default="ResNet", help='{ResNet|MLP}')
    parser.add_argument('--mlp_encoder_dim', type=int, default=None, help='dimension of intermediate MLP encoder layers')
    parser.add_argument('--mlp_encoder_layers', type=int, default=None, help='number of MLP encoding layers')
